...
add wave -noupdate -expand -group {Hazard Control} -label {idRegisterRs [in]} /cachedmips32test/processor/hazard_contol_logic/idRegisterRs
add wave -noupdate -expand -group {Hazard Control} -label {idRegisterRt [in]} /cachedmips32test/processor/hazard_contol_logic/idRegisterRt
add wave -noupdate -expand -group {Hazard Control} -label {exeRegisterRd [in]} /cachedmips32test/processor/hazard_contol_logic/exeRegisterRd
add wave -noupdate -expand -group {Hazard Control} -label {tagRegisterRd [in]} /cachedmips32test/processor/hazard_contol_logic/tagRegisterRd
add wave -noupdate -expand -group {Hazard Control} -label {exeMemRead [in]} /cachedmips32test/processor/hazard_contol_logic/exeMemRead
add wave -noupdate -expand -group {Hazard Control} -label {tagMemRead [in]} /cachedmips32test/processor/hazard_contol_logic/tagMemRead
add wave -noupdate -expand -group {Hazard Control} -label {Branch [in]} /cachedmips32test/processor/hazard_contol_logic/Branch
add wave -noupdate -expand -group {Hazard Control} -label {Jump [in]} /cachedmips32test/processor/hazard_contol_logic/Jump
add wave -noupdate -expand -group {Hazard Control} -label {Exception [in]} /cachedmips32test/processor/hazard_contol_logic/Exception
add wave -noupdate -expand -group {Hazard Control} -label {Interrupt [in]} /cachedmips32test/processor/hazard_contol_logic/Interrupt
add wave -noupdate -expand -group {Hazard Control} -label {Interrupt_to_Exception_ctrl [out]} /cachedmips32test/processor/hazard_contol_logic/Interrupt_to_Exception_ctrl
add wave -noupdate -expand -group {Hazard Control} -label {Inst Cache Ready [in]} /cachedmips32test/processor/hazard_contol_logic/IC_Ready
add wave -noupdate -expand -group {Hazard Control} -label {Data Cache Ready [in]} /cachedmips32test/processor/hazard_contol_logic/DC_Ready
add wave -noupdate -expand -group {Hazard Control} -label {Stall PC [out]} /cachedmips32test/processor/hazard_contol_logic/Stall_PC
add wave -noupdate -expand -group {Hazard Control} -label {Stall IF_ID [out]} /cachedmips32test/processor/hazard_contol_logic/Stall_IF_ID
add wave -noupdate -expand -group {Hazard Control} -label {Stall ID_EXE [out]} /cachedmips32test/processor/hazard_contol_logic/Stall_ID_EXE
add wave -noupdate -expand -group {Hazard Control} -label {Stall EXE_LOOKUP [out]} /cachedmips32test/processor/hazard_contol_logic/Stall_EXE_LOOKUP
add wave -noupdate -expand -group {Hazard Control} -label {NOP to ID [out]} /cachedmips32test/processor/hazard_contol_logic/NOP_to_ID
add wave -noupdate -expand -group {Hazard Control} -label {NOP to EXE [out]} /cachedmips32test/processor/hazard_contol_logic/NOP_to_EXE
add wave -noupdate -expand -group {Hazard Control} -label {NOP to L [out]} /cachedmips32test/processor/hazard_contol_logic/NOP_to_L
add wave -noupdate -expand -group {Hazard Control} -label {NOP to C [out]} /cachedmips32test/processor/hazard_contol_logic/NOP_to_C
add wave -noupdate -expand -group {Hazard Control} -label {NOP to WB [out]} /cachedmips32test/processor/hazard_contol_logic/NOP_to_WB
add wave -noupdate -expand -group {Forward Control} -label {idRegisterRs [in]} -radix hexadecimal /cachedmips32test/processor/forwarding_control_logic/idRegisterRs
add wave -noupdate -expand -group {Forward Control} -label {idRegisterRt [in]} -radix hexadecimal /cachedmips32test/processor/forwarding_control_logic/idRegisterRt
add wave -noupdate -expand -group {Forward Control} -label {exeRegisterRd [in]} -radix hexadecimal /cachedmips32test/processor/forwarding_control_logic/exeRegisterRd
add wave -noupdate -expand -group {Forward Control} -label {exeRegisterRt [in]} -radix hexadecimal /cachedmips32test/processor/forwarding_control_logic/exeRegisterRt
add wave -noupdate -expand -group {Forward Control} -label {tagRegisterRd [in]} -radix hexadecimal /cachedmips32test/processor/forwarding_control_logic/tagRegisterRd
add wave -noupdate -expand -group {Forward Control} -label {dcaRegisterRd [in]} -radix hexadecimal /cachedmips32test/processor/forwarding_control_logic/dcaRegisterRd
add wave -noupdate -expand -group {Forward Control} -label {exeRegWrite [in]} -radix hexadecimal /cachedmips32test/processor/forwarding_control_logic/exeRegWrite
add wave -noupdate -expand -group {Forward Control} -label {tagRegWrite [in]} -radix hexadecimal /cachedmips32test/processor/forwarding_control_logic/tagRegWrite
add wave -noupdate -expand -group {Forward Control} -label {dcaRegWrite [in]} -radix hexadecimal /cachedmips32test/processor/forwarding_control_logic/dcaRegWrite
add wave -noupdate -expand -group {Forward Control} -label {idMemWrite [in]} -radix hexadecimal /cachedmips32test/processor/forwarding_control_logic/idMemWrite
add wave -noupdate -expand -group {Forward Control} -label {exeMemWrite [in]} -radix binary /cachedmips32test/processor/forwarding_control_logic/exeMemWrite
add wave -noupdate -expand -group {Forward Control} -label {fwd_aluRs [out]} -radix binary /cachedmips32test/processor/forwarding_control_logic/fwd_aluRs
add wave -noupdate -expand -group {Forward Control} -label {fwd_aluRt [out]} -radix binary /cachedmips32test/processor/forwarding_control_logic/fwd_aluRt
add wave -noupdate -expand -group {Forward Control} -label {fwd_alu_regmem [out]} -radix binary /cachedmips32test/processor/forwarding_control_logic/fwd_alu_regmem
add wave -noupdate -expand -group {Forward Control} -label {fwd_lookup_regmem [out]} -radix binary /cachedmips32test/processor/forwarding_control_logic/fwd_lookup_regmem
add wave -noupdate -expand -group {Forward Control} -label {fwd_cache_regmem [out]} -radix binary /cachedmips32test/processor/forwarding_control_logic/fwd_cache_regmem
...
add wave -noupdate -expand -group {Mux PC+4} -label {addr_branch [PCSrc=1]} -radix hexadecimal /cachedmips32test/processor/first_stage/addr_branch
add wave -noupdate -expand -group {Mux PC+4} -label {addr_jump [Jump=1]} -radix hexadecimal /cachedmips32test/processor/first_stage/addr_jump
add wave -noupdate -expand -group {Mux PC+4} -label PCSrc -radix hexadecimal /cachedmips32test/processor/first_stage/PCSrc
add wave -noupdate -expand -group {Mux PC+4} -label Jump -radix hexadecimal /cachedmips32test/processor/first_stage/Jump_tmp
add wave -noupdate -expand -group {Mux PC+4} -label ExceptionJump -radix hexadecimal /cachedmips32test/processor/first_stage/ExceptionJump
add wave -noupdate -expand -group {Mux PC+4} -label {PC+4 (Out)} -radix hexadecimal /cachedmips32test/processor/first_stage/pc_up_tmp
...
add wave -noupdate -label instruction -radix hexadecimal -childformat {{/cachedmips32test/processor/first_stage/instruction(31) -radix hexadecimal} {/cachedmips32test/processor/first_stage/instruction(30) -radix hexadecimal} {/cachedmips32test/processor/first_stage/instruction(29) -radix hexadecimal} {/cachedmips32test/processor/first_stage/instruction(28) -radix hexadecimal} {/cachedmips32test/processor/first_stage/instruction(27) -radix hexadecimal} {/cachedmips32test/processor/first_stage/instruction(26) -radix hexadecimal} {/cachedmips32test/processor/first_stage/instruction(25) -radix hexadecimal} {/cachedmips32test/processor/first_stage/instruction(24) -radix hexadecimal} {/cachedmips32test/processor/first_stage/instruction(23) -radix hexadecimal} {/cachedmips32test/processor/first_stage/instruction(22) -radix hexadecimal} {/cachedmips32test/processor/first_stage/instruction(21) -radix hexadecimal} {/cachedmips32test/processor/first_stage/instruction(20) -radix hexadecimal} {/cachedmips32test/processor/first_stage/instruction(19) -radix hexadecimal} {/cachedmips32test/processor/first_stage/instruction(18) -radix hexadecimal} {/cachedmips32test/processor/first_stage/instruction(17) -radix hexadecimal} {/cachedmips32test/processor/first_stage/instruction(16) -radix hexadecimal} {/cachedmips32test/processor/first_stage/instruction(15) -radix hexadecimal} {/cachedmips32test/processor/first_stage/instruction(14) -radix hexadecimal} {/cachedmips32test/processor/first_stage/instruction(13) -radix hexadecimal} {/cachedmips32test/processor/first_stage/instruction(12) -radix hexadecimal} {/cachedmips32test/processor/first_stage/instruction(11) -radix hexadecimal} {/cachedmips32test/processor/first_stage/instruction(10) -radix hexadecimal} {/cachedmips32test/processor/first_stage/instruction(9) -radix hexadecimal} {/cachedmips32test/processor/first_stage/instruction(8) -radix hexadecimal} {/cachedmips32test/processor/first_stage/instruction(7) -radix hexadecimal} {/cachedmips32test/processor/first_stage/instruction(6) -radix hexadecimal} {/cachedmips32test/processor/first_stage/instruction(5) -radix hexadecimal} {/cachedmips32test/processor/first_stage/instruction(4) -radix hexadecimal} {/cachedmips32test/processor/first_stage/instruction(3) -radix hexadecimal} {/cachedmips32test/processor/first_stage/instruction(2) -radix hexadecimal} {/cachedmips32test/processor/first_stage/instruction(1) -radix hexadecimal} {/cachedmips32test/processor/first_stage/instruction(0) -radix hexadecimal}} -subitemconfig {/cachedmips32test/processor/first_stage/instruction(31) {-height 17 -radix hexadecimal} /cachedmips32test/processor/first_stage/instruction(30) {-height 17 -radix hexadecimal} /cachedmips32test/processor/first_stage/instruction(29) {-height 17 -radix hexadecimal} /cachedmips32test/processor/first_stage/instruction(28) {-height 17 -radix hexadecimal} /cachedmips32test/processor/first_stage/instruction(27) {-height 17 -radix hexadecimal} /cachedmips32test/processor/first_stage/instruction(26) {-height 17 -radix hexadecimal} /cachedmips32test/processor/first_stage/instruction(25) {-height 17 -radix hexadecimal} /cachedmips32test/processor/first_stage/instruction(24) {-height 17 -radix hexadecimal} /cachedmips32test/processor/first_stage/instruction(23) {-height 17 -radix hexadecimal} /cachedmips32test/processor/first_stage/instruction(22) {-height 17 -radix hexadecimal} /cachedmips32test/processor/first_stage/instruction(21) {-height 17 -radix hexadecimal} /cachedmips32test/processor/first_stage/instruction(20) {-height 17 -radix hexadecimal} /cachedmips32test/processor/first_stage/instruction(19) {-height 17 -radix hexadecimal} /cachedmips32test/processor/first_stage/instruction(18) {-height 17 -radix hexadecimal} /cachedmips32test/processor/first_stage/instruction(17) {-height 17 -radix hexadecimal} /cachedmips32test/processor/first_stage/instruction(16) {-height 17 -radix hexadecimal} /cachedmips32test/processor/first_stage/instruction(15) {-height 17 -radix hexadecimal} /cachedmips32test/processor/first_stage/instruction(14) {-height 17 -radix hexadecimal} /cachedmips32test/processor/first_stage/instruction(13) {-height 17 -radix hexadecimal} /cachedmips32test/processor/first_stage/instruction(12) {-height 17 -radix hexadecimal} /cachedmips32test/processor/first_stage/instruction(11) {-height 17 -radix hexadecimal} /cachedmips32test/processor/first_stage/instruction(10) {-height 17 -radix hexadecimal} /cachedmips32test/processor/first_stage/instruction(9) {-height 17 -radix hexadecimal} /cachedmips32test/processor/first_stage/instruction(8) {-height 17 -radix hexadecimal} /cachedmips32test/processor/first_stage/instruction(7) {-height 17 -radix hexadecimal} /cachedmips32test/processor/first_stage/instruction(6) {-height 17 -radix hexadecimal} /cachedmips32test/processor/first_stage/instruction(5) {-height 17 -radix hexadecimal} /cachedmips32test/processor/first_stage/instruction(4) {-height 17 -radix hexadecimal} /cachedmips32test/processor/first_stage/instruction(3) {-height 17 -radix hexadecimal} /cachedmips32test/processor/first_stage/instruction(2) {-height 17 -radix hexadecimal} /cachedmips32test/processor/first_stage/instruction(1) {-height 17 -radix hexadecimal} /cachedmips32test/processor/first_stage/instruction(0) {-height 17 -radix hexadecimal}} /cachedmips32test/processor/first_stage/instruction
...
add wave -noupdate -expand -group {Register File} -label clk /cachedmips32test/processor/second_stage/register_file/clk
add wave -noupdate -expand -group {Register File} -label {addr_rs [in]} -radix hexadecimal /cachedmips32test/processor/second_stage/register_file/addr_rs
add wave -noupdate -expand -group {Register File} -label {addr_rt [in]} -radix hexadecimal /cachedmips32test/processor/second_stage/register_file/addr_rt
add wave -noupdate -expand -group {Register File} -label {addr_rd [in]} -radix hexadecimal /cachedmips32test/processor/second_stage/register_file/addr_rd
add wave -noupdate -expand -group {Register File} -label {rs [out]} -radix hexadecimal /cachedmips32test/processor/second_stage/register_file/rs
add wave -noupdate -expand -group {Register File} -label {rt [out]} -radix hexadecimal /cachedmips32test/processor/second_stage/register_file/rt
add wave -noupdate -expand -group {Register File} -label {rd [in]} -radix hexadecimal /cachedmips32test/processor/second_stage/register_file/rd
add wave -noupdate -expand -group {Register File} -label {RegWrite [in]} -radix hexadecimal /cachedmips32test/processor/second_stage/register_file/RegWrite
add wave -noupdate -expand -group {Register File} -label register_file -radix hexadecimal -childformat {{/cachedmips32test/processor/second_stage/register_file/reg(31) -radix hexadecimal} {/cachedmips32test/processor/second_stage/register_file/reg(30) -radix hexadecimal} {/cachedmips32test/processor/second_stage/register_file/reg(29) -radix hexadecimal} {/cachedmips32test/processor/second_stage/register_file/reg(28) -radix hexadecimal} {/cachedmips32test/processor/second_stage/register_file/reg(27) -radix hexadecimal} {/cachedmips32test/processor/second_stage/register_file/reg(26) -radix hexadecimal} {/cachedmips32test/processor/second_stage/register_file/reg(25) -radix hexadecimal} {/cachedmips32test/processor/second_stage/register_file/reg(24) -radix hexadecimal} {/cachedmips32test/processor/second_stage/register_file/reg(23) -radix hexadecimal} {/cachedmips32test/processor/second_stage/register_file/reg(22) -radix hexadecimal} {/cachedmips32test/processor/second_stage/register_file/reg(21) -radix hexadecimal} {/cachedmips32test/processor/second_stage/register_file/reg(20) -radix hexadecimal} {/cachedmips32test/processor/second_stage/register_file/reg(19) -radix hexadecimal} {/cachedmips32test/processor/second_stage/register_file/reg(18) -radix hexadecimal} {/cachedmips32test/processor/second_stage/register_file/reg(17) -radix hexadecimal} {/cachedmips32test/processor/second_stage/register_file/reg(16) -radix hexadecimal} {/cachedmips32test/processor/second_stage/register_file/reg(15) -radix hexadecimal} {/cachedmips32test/processor/second_stage/register_file/reg(14) -radix hexadecimal} {/cachedmips32test/processor/second_stage/register_file/reg(13) -radix hexadecimal} {/cachedmips32test/processor/second_stage/register_file/reg(12) -radix hexadecimal} {/cachedmips32test/processor/second_stage/register_file/reg(11) -radix hexadecimal} {/cachedmips32test/processor/second_stage/register_file/reg(10) -radix hexadecimal} {/cachedmips32test/processor/second_stage/register_file/reg(9) -radix hexadecimal} {/cachedmips32test/processor/second_stage/register_file/reg(8) -radix hexadecimal} {/cachedmips32test/processor/second_stage/register_file/reg(7) -radix hexadecimal} {/cachedmips32test/processor/second_stage/register_file/reg(6) -radix hexadecimal} {/cachedmips32test/processor/second_stage/register_file/reg(5) -radix hexadecimal} {/cachedmips32test/processor/second_stage/register_file/reg(4) -radix hexadecimal} {/cachedmips32test/processor/second_stage/register_file/reg(3) -radix hexadecimal} {/cachedmips32test/processor/second_stage/register_file/reg(2) -radix hexadecimal} {/cachedmips32test/processor/second_stage/register_file/reg(1) -radix hexadecimal} {/cachedmips32test/processor/second_stage/register_file/reg(0) -radix hexadecimal}} -subitemconfig {/cachedmips32test/processor/second_stage/register_file/reg(31) {-height 17 -radix hexadecimal} /cachedmips32test/processor/second_stage/register_file/reg(30) {-height 17 -radix hexadecimal} /cachedmips32test/processor/second_stage/register_file/reg(29) {-height 17 -radix hexadecimal} /cachedmips32test/processor/second_stage/register_file/reg(28) {-height 17 -radix hexadecimal} /cachedmips32test/processor/second_stage/register_file/reg(27) {-height 17 -radix hexadecimal} /cachedmips32test/processor/second_stage/register_file/reg(26) {-height 17 -radix hexadecimal} /cachedmips32test/processor/second_stage/register_file/reg(25) {-height 17 -radix hexadecimal} /cachedmips32test/processor/second_stage/register_file/reg(24) {-height 17 -radix hexadecimal} /cachedmips32test/processor/second_stage/register_file/reg(23) {-height 17 -radix hexadecimal} /cachedmips32test/processor/second_stage/register_file/reg(22) {-height 17 -radix hexadecimal} /cachedmips32test/processor/second_stage/register_file/reg(21) {-height 17 -radix hexadecimal} /cachedmips32test/processor/second_stage/register_file/reg(20) {-height 17 -radix hexadecimal} /cachedmips32test/processor/second_stage/register_file/reg(19) {-height 17 -radix hexadecimal} /cachedmips32test/processor/second_stage/register_file/reg(18) {-height 17 -radix hexadecimal} /cachedmips32test/processor/second_stage/register_file/reg(17) {-height 17 -radix hexadecimal} /cachedmips32test/processor/second_stage/register_file/reg(16) {-height 17 -radix hexadecimal} /cachedmips32test/processor/second_stage/register_file/reg(15) {-height 17 -radix hexadecimal} /cachedmips32test/processor/second_stage/register_file/reg(14) {-height 17 -radix hexadecimal} /cachedmips32test/processor/second_stage/register_file/reg(13) {-height 17 -radix hexadecimal} /cachedmips32test/processor/second_stage/register_file/reg(12) {-height 17 -radix hexadecimal} /cachedmips32test/processor/second_stage/register_file/reg(11) {-height 17 -radix hexadecimal} /cachedmips32test/processor/second_stage/register_file/reg(10) {-height 17 -radix hexadecimal} /cachedmips32test/processor/second_stage/register_file/reg(9) {-height 17 -radix hexadecimal} /cachedmips32test/processor/second_stage/register_file/reg(8) {-height 17 -radix hexadecimal} /cachedmips32test/processor/second_stage/register_file/reg(7) {-height 17 -radix hexadecimal} /cachedmips32test/processor/second_stage/register_file/reg(6) {-height 17 -radix hexadecimal} /cachedmips32test/processor/second_stage/register_file/reg(5) {-height 17 -radix hexadecimal} /cachedmips32test/processor/second_stage/register_file/reg(4) {-height 17 -radix hexadecimal} /cachedmips32test/processor/second_stage/register_file/reg(3) {-height 17 -radix hexadecimal} /cachedmips32test/processor/second_stage/register_file/reg(2) {-height 17 -radix hexadecimal} /cachedmips32test/processor/second_stage/register_file/reg(1) {-height 17 -radix hexadecimal} /cachedmips32test/processor/second_stage/register_file/reg(0) {-height 17 -radix hexadecimal}} /cachedmips32test/processor/second_stage/register_file/reg
...
add wave -noupdate -expand -group {Mux Rt} -label {fwd_path_alu [11]} -radix hexadecimal /cachedmips32test/processor/second_stage/fwd_path_alu
add wave -noupdate -expand -group {Mux Rt} -label {fwd_path_lookup [10]} -radix hexadecimal /cachedmips32test/processor/second_stage/fwd_path_lookup
add wave -noupdate -expand -group {Mux Rt} -label {fwd_path_cache [01]} -radix hexadecimal /cachedmips32test/processor/second_stage/fwd_path_cache
add wave -noupdate -expand -group {Mux Rt} -label {rt_regfile [00]} -radix hexadecimal /cachedmips32test/processor/second_stage/rt_regfile
add wave -noupdate -expand -group {Mux Rt} -label {fwd_aluRt [Control Mux]} -radix hexadecimal /cachedmips32test/processor/second_stage/fwd_aluRt
add wave -noupdate -expand -group {Mux Rt} -label {rt [out]} -radix hexadecimal /cachedmips32test/processor/second_stage/rt
add wave -noupdate -group {Mux Write Data(dcache)} -label {fwd_path_alu [11]} -radix hexadecimal /cachedmips32test/processor/second_stage/fwd_path_alu
add wave -noupdate -group {Mux Write Data(dcache)} -label {fwd_path_lookup [10]} -radix hexadecimal /cachedmips32test/processor/second_stage/fwd_path_lookup
add wave -noupdate -group {Mux Write Data(dcache)} -label {fwd_path_cache [01]} -radix hexadecimal /cachedmips32test/processor/second_stage/fwd_path_cache
add wave -noupdate -group {Mux Write Data(dcache)} -label {rt_regfile [00]} -radix hexadecimal /cachedmips32test/processor/second_stage/rt_regfile
add wave -noupdate -group {Mux Write Data(dcache)} -label {fwd_alu_regmem [Control Mux]} -radix hexadecimal /cachedmips32test/processor/second_stage/fwd_alu_regmem
add wave -noupdate -group {Mux Write Data(dcache)} -label {write_data [out]} -radix hexadecimal /cachedmips32test/processor/second_stage/write_data
...
add wave -noupdate -group {Mux Entrada A ALU} -label {rs_reg [Shift=0]} -radix hexadecimal /cachedmips32test/processor/third_stage/rs_reg
add wave -noupdate -group {Mux Entrada A ALU} -label {rt_reg [Shift=1]} -radix hexadecimal /cachedmips32test/processor/third_stage/rt_reg
add wave -noupdate -group {Mux Entrada A ALU} -label ShiftSrc -radix hexadecimal /cachedmips32test/processor/third_stage/ShiftSrc
add wave -noupdate -group {Mux Entrada A ALU} -label alusrc_a_mux -radix hexadecimal /cachedmips32test/processor/third_stage/alusrc_a_mux
add wave -noupdate -group {Mux Entrada B ALU} -label {zero_ext_reg [SignedSRrc=0]} -radix hexadecimal /cachedmips32test/processor/third_stage/zero_ext_reg
add wave -noupdate -group {Mux Entrada B ALU} -label {sign_ext_reg [SignedSrc=1]} -radix hexadecimal /cachedmips32test/processor/third_stage/sign_ext_reg
add wave -noupdate -group {Mux Entrada B ALU} -label SignedSrc -radix hexadecimal /cachedmips32test/processor/third_stage/SignedSrc
add wave -noupdate -group {Mux Entrada B ALU} -label {sign_immed_mux [Partial Result]} -radix hexadecimal /cachedmips32test/processor/third_stage/sign_immed_mux
add wave -noupdate -group {Mux Entrada B ALU} -label {rt_reg [ALUSrc=0]} -radix hexadecimal /cachedmips32test/processor/third_stage/rt_reg
add wave -noupdate -group {Mux Entrada B ALU} -label {sign_immed_mux [ALUSrc=1]} -radix hexadecimal /cachedmips32test/processor/third_stage/sign_immed_mux
add wave -noupdate -group {Mux Entrada B ALU} -label ALUSrc_reg -radix hexadecimal /cachedmips32test/processor/third_stage/ALUSrc_reg
add wave -noupdate -group {Mux Entrada B ALU} -label {alusrc_b_mux [Partial Result]} -radix hexadecimal /cachedmips32test/processor/third_stage/alusrc_b_mux
add wave -noupdate -group {Mux Entrada B ALU} -label {alusrc_b_mux [Shift=0]} -radix hexadecimal /cachedmips32test/processor/third_stage/alusrc_b_mux
add wave -noupdate -group {Mux Entrada B ALU} -label {shamt [Shift=1]} -radix hexadecimal /cachedmips32test/processor/third_stage/shamt
add wave -noupdate -group {Mux Entrada B ALU} -label ShiftSrc -radix hexadecimal /cachedmips32test/processor/third_stage/ShiftSrc
add wave -noupdate -group {Mux Entrada B ALU} -label {shiftsrc_mux [OUT Entrada B ALU]} -radix hexadecimal /cachedmips32test/processor/third_stage/shiftsrc_mux
...
add wave -noupdate -label {busWrDataMemWrite [out]} -radix hexadecimal /cachedmips32test/processor/fourth_stage/busWrDataMemWrite
add wave -noupdate -label {busAddrDC [out]} -radix hexadecimal /cachedmips32test/processor/fourth_stage/busAddrDC
...
WaveRestoreCursors {{Cursor 1} {3702 ps} 0}
...
update
WaveRestoreZoom {2515 ps} {4079 ps}
